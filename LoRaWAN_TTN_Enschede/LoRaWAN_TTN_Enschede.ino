...
// Sleutelset voor 
unsigned char DevAddr[4] = { 0x26, 0x01, 0x12, 0xF3 };
unsigned char NwkSkey[16] = { 0x8B, 0x1D, 0x82, 0xFB, 0x68, 0xF2, 0x2F, 0x4D, 0x70, 0xCC, 0xD0, 0x3D, 0x16, 0x0F, 0x5B, 0x90 };
unsigned char AppSkey[16] = { 0xAF, 0x0E, 0x7C, 0x4A, 0xE5, 0x59, 0x1A, 0x09, 0x7F, 0x6C, 0xC0, 0x5F, 0x54, 0x44, 0xAD, 0x18 };
